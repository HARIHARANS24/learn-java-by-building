...
└── hariharans24-learn-java-by-building/
    ...
    └── src/
        ...
        │   ├── ArraysIntro.java
        │   ├── InputArrays.java
        │   ├── SearchItemInAnArray.java
        │   ├── TelephoneNumberPad.java
        │   ├── TwoDArrays.java
        │   └── VariableArgs.java
        ├── ConditionalStatement/
        │   ├── EnhancedSwitchWeekday.java
        │   ├── IfStatement.java
        │   ├── IfWeekday.java
        │   ├── NestedIf.java
        │   └── SwitchWeekday.java
        ...
        │   ├── CountDownTimer.java
        │   ├── CountDownTimer2.java
        │   ├── DiceRollerProgram.java
        │   ├── MadLibsGame.java
        │   ├── MatrixBuilder.java
        │   ├── NumberGuessingGame.java
        │   ├── QuizGame.java
        │   ├── RockPaperScissors.java
        │   ├── ShoppingCartProgram.java
        │   ├── SlotMachine.java
        ...
        │   ├── AugmentedAssignmentOperator.java
        │   ├── IncrementandDecrementOperator.java
